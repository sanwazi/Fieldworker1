...
public class DatabaseHelper extends SQLiteOpenHelper {
	...
	public void onCreate(SQLiteDatabase db) {
        ...
        db.execSQL("create table Observation(observationID INTEGER PRIMARY KEY, observationName VARCHAR(225) UNIQUE,username VARCHAR(45), traitListID INTEGER, createTime DATETIME NOT NULL default current_timestamp,endTime DATETIME,photoPath VARCHAR(225), paintingPath VARCHAR(225), comment VARCHAR(225) )");
        db.execSQL("create table PredefineVal(predefineValID INTEGER PRIMARY KEY,traitID INTEGER, value VARCHAR(128))");
	    db.execSQL("create table Trait(traitID INTEGER PRIMARY KEY,traitName VARCHAR(128),widgetName VARCHAR(128),unit VARCHAR(45),username VARCHAR(45),accessible INTEGER DEFAULT 1,nameVersion INTEGER DEFAULT 0)");
